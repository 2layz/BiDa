...
d3.json('http://192.168.228.134:28080/api/get/rules', function(err,data){
if(err) console.log("error fetching data");
  ...
  const charts = [
      ...
      .x(d3.scaleTime()
        .domain([new Date(2018, 1, 1), new Date(2018, 1, 28)])
        .rangeRound([0, 10 * 90]))
      .filter([new Date(2018, 1, 1), new Date(2018, 2, 1)]),
